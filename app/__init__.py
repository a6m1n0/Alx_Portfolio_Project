...
def create_app(config_name):
    ...
    from .api.v1 import (auth, election, vote, candidate)

    app.register_blueprint(election.election_bp, url_prefix='/api/v1/')
    app.register_blueprint(auth.auth_bp, url_prefix='/api/v1/auth')
    app.register_blueprint(vote.vote_bp, url_prefix='/api/v1/')
    app.register_blueprint(candidate.candidate_bp, url_prefix='/api/v1/')
